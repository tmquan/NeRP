...
try:
    ...
    need_monai=True
if need_monai:
    os.system("pip install monai[all] -U --force-reinstall")
...
if need_pytorch3d:
    if torch.__version__.startswith("1.7") and sys.platform.startswith("linux"):
        ...
        if not os.path.exists('cub-1.10.0'):
            os.system("wget https://github.com/NVIDIA/cub/archive/1.10.0.tar.gz")
            os.system("tar xzf 1.10.0.tar.gz")
        os.environ["CUB_HOME"] = "cub-1.10.0"
        os.system("pip install 'git+https://github.com/facebookresearch/pytorch3d.git@stable' -U --force-reinstall")
